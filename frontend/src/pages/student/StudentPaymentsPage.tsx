  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-red-600 to-black dark:from-red-700 dark:to-gray-900 px-5 py-4">
          <h3 className="text-white font-bold text-base flex items-center gap-2">
            <CreditCard size={18} /> Online To'lov
          </h3>
          <p className="text-red-300 dark:text-red-400 text-xs mt-0.5">{calcData.groupName} · {calcData.courseName}</p>
        </div>
        ...
        <div className="p-5 space-y-4">
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    numAmount === opt.value
                      ...
                      : 'border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-red-300 hover:bg-red-50 dark:hover:bg-gray-700'
                  )}
                >
                  {opt.label}
                  <br />
            ...
            <button
              ...
              className={clsx(
                ...
                numAmount === calcData.debtAmount
                  ? 'bg-red-50 dark:bg-red-900/20 border-red-500 dark:border-red-700 text-red-700 dark:text-red-400'
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                min={1000}
                step={1000}
                className="w-full px-4 py-2.5 pr-14 rounded-xl border border-gray-200 dark:border-gray-600 text-sm
          ...
          <button
            onClick={onClose}
            className="w-full py-2.5 rounded-xl border border-gray-200 dark:border-gray-600 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition"
          >
            Bekor qilish
          </button>
...
const StudentPaymentsPage = () => {
  ...
  return (
    <div className="space-y-5 animate-fade-in dark:bg-gray-900 dark:text-gray-100">
      ...
      {/* Header */}
      <div className="rounded-2xl bg-gradient-to-r from-red-600 via-red-700 to-black dark:from-red-700 dark:via-red-800 dark:to-gray-900 p-5 text-white">
      ...
      {paymentDueDay && nextDueDate && (
        <div className={clsx(
          ...
          <div className={clsx(
            ...
            daysLeft !== null && daysLeft <= 3 ? 'bg-red-100 dark:bg-red-900/50' : 'bg-amber-100 dark:bg-amber-900/50'
          )}>
            {daysLeft !== null && daysLeft <= 0 ? '⚠️' : '📅'}
          </div>
          <div className="flex-1">
            <p className={clsx('font-bold text-sm',
              daysLeft !== null && daysLeft <= 3 ? 'text-red-700 dark:text-red-400' : 'text-amber-800 dark:text-amber-400')}>
      ...
      {/* Payment calculation */}
      {calcLoading ? (
        <div className="card dark:bg-gray-800 dark:border-gray-700 flex items-center justify-center py-8 text-gray-400 dark:text-gray-500 text-sm gap-2">
        ...
        <div className="card dark:bg-gray-800 dark:border-gray-700 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-3 border border-red-100 dark:border-red-900">
              <p className="text-xs text-red-500 dark:text-red-400 mb-1 font-medium">
                {calcData.isProRata ? 'Pro-rata to\'lov' : calcData.holidayCredit > 0 ? 'Moslashtirilgan to\'lov' : 'Oylik to\'lov'}
              </p>
              ...
              {calcData.isProRata && (
                <p className="text-[10px] text-blue-600 dark:text-blue-400 mt-0.5 font-medium">
                  📐 Pro-rata: {calcData.proRataLessons} dars
                </p>
              )}
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-3 border border-gray-100 dark:border-gray-600">
              ...
              <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-0.5">
                {calcData.isProRata ? `📐 Pro-rata: ${calcData.proRataLessons} dars` : `${calcData.lessonsPerMonth}/${calcData.standardLessons} dars/oy`}
              </p>
            </div>
          </div>
          ...
          {/* Debt alert */}
          {calcData.debtAmount > 0 && (
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900 rounded-xl p-3 flex items-start gap-3">
              <div className="w-9 h-9 rounded-full bg-red-100 dark:bg-red-900/50 flex items-center justify-center flex-shrink-0 text-lg">💸</div>
              <div>
                <p className="text-sm font-bold text-red-700 dark:text-red-400">Joriy qarz: {fmt(calcData.debtAmount)}</p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Keyingi oy uchun ({calcData.nextMonthLessons} dars)</p>
                <p className="text-sm font-bold text-gray-700 dark:text-gray-200">{fmt(calcData.nextMonthAmount)}</p>
              </div>
            </div>
        ...
        <div className="card dark:bg-gray-800 dark:border-gray-700 text-center py-8 text-gray-400 dark:text-gray-500 text-sm">
        ...
        <div className="card dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="space-y-3">
            {fees.map((fee: {
              ...
              return (
                <div key={fee.id} className="p-3 rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="font-bold text-gray-800 dark:text-gray-100">{fmt(feeAmount)}</span>
                  </div>
                  {/* Attendance bar */}
        ...
        {isLoading ? (
          ...
          <div className="space-y-2">
            {payments.map((p: {
              ...
              <div key={p.id} className="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition border border-transparent hover:border-gray-100 dark:hover:border-gray-600">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-900/30 flex items-center justify-center text-lg flex-shrink-0">
