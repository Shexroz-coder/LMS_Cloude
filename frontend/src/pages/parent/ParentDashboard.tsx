...
const ParentDashboard = () => {
  ...
  return (
    <div className="space-y-5 animate-fade-in dark:bg-gray-900 dark:text-gray-100">
      ...
      {children.length === 0 ? (
        <div className="card dark:bg-gray-800 dark:border-gray-700 text-center py-10">
          <div className="text-4xl mb-3">👶</div>
          <p className="text-gray-500 dark:text-gray-400 font-medium">Farzandlar ro'yxati topilmadi</p>
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">Admin orqali farzandingizni tizimga biriktiring</p>
        </div>
      ) : (
        <>
                  ...
                  <button
                    ...
                    className={clsx(
                      ...
                      i === selectedChildIdx
                        ...
                        : 'bg-white dark:bg-gray-700 text-gray-600 dark:text-gray-300 border-gray-200 dark:border-gray-600 hover:border-indigo-300 hover:bg-indigo-50 dark:hover:bg-gray-600'
                    )}
                  >
                    {child.user.fullName}
                  </button>
          ...
          {selectedChild && (
            <div className="card bg-gradient-to-br from-indigo-500 to-violet-600 dark:from-indigo-600 dark:to-violet-700 text-white">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Link
          to="/parent/payments"
          className="card dark:bg-gray-800 dark:border-gray-700 dark:hover:border-indigo-600 dark:hover:bg-indigo-900/20 flex items-center gap-3 p-4 hover:border-indigo-200 hover:bg-indigo-50
