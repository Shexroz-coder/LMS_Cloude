...
export interface SessionData {
  ...
  step: 'idle' | 'waiting_phone' | 'waiting_otp' | 'waiting_parent_child_name' | 'waiting_parent_child_phone' | 'waiting_late_att_reason' | 'waiting_broadcast_text' | 'waiting_coin_amount' | 'waiting_new_password';
