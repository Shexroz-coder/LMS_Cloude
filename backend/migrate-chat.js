/**
 * Chat tizimi uchun ma'lumotlar bazasi migration skripti
 * Mac terminalida ishga tushirish:
 *   cd backend && node migrate-chat.js
 */
...
// Temp SQL file
const tmpFile = path.join(__dirname, 'tmp_migration.sql');
